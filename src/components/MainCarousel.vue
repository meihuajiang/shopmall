...
export default {
  data() {
    return {
      ...
      fadeItems: [
        {
          imgUrl: "./static/img/xmad-1.jpg",
          link: "http://book.dangdang.com/20200330_au0d"
        },
        {
          imgUrl: "./static/img/xmad-2.jpg",
          link: "http://book.dangdang.com/20200330_au0d"
        },
        {
          imgUrl: "./static/img/xmad-3.jpg",
          link: "http://book.dangdang.com/20200330_au0d"
        },
        {
          imgUrl: "./static/img/xmad-4.jpg",
          link: "http://book.dangdang.com/20200330_au0d"
        },
        {
          imgUrl: "./static/img/xmad-5.jpg",
          link: "http://book.dangdang.com/20200330_au0d"
        }
      ]
    };
  ...
  mounted() {
    //Vue2.0 替换了之前的ready，详见文档生命周期函数mounted
    this.autoPlay();
  },
  methods: {
    playNext() {
